<!-- Bootstrap Modals -->
<!-- Modal - DELETE -->
<div class="modal fade" id="modaldelete<?php echo $row['assistantid']; ?>" tabindex="-1" data-bs-keyboard="false" data-bs-backdrop="static" role="dialog" aria-labelledby="myModalLabel">
...
<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
	...
	<div class="modal-body">
			...
			<?php $assistantid=$row['assistantid'];?>
			<input type="hidden"  name="assistantid" value="<?php echo $assistantid; ?>"/>
			...
			<div class="mb-3">
				...
				<div class="form-group">
				<div class="input-group">
				<input type="text"  name="user" class="form-control" value="<?php echo $row['user']?>" disabled>
				</div>
				</div>
				</div>
				</div>
