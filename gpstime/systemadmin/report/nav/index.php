...
<a class="navbar-brand" href="#" style="font-size: 16px;padding: 0px 6px 0px 12px;color: white;"><b>DASHBOARD<br>STATUS : <?php echo $_SESSION['aname'] ?></b></a>
...
<ul class="navbar-nav ms-auto topnav">
  ...
  <a style="color:white;" class="nav-link active" aria-current="page" href="../../home/"> หน้าหลัก</a>
    ...
    <li class="nav-item">
  <a style="color:white;" class="nav-link active" aria-current="page" href="../../report/"> รายงาน</a>
  </li>
   <li class="nav-item">
...
<h4><?php echo $rowsetup['system'];?></h4>
</div>