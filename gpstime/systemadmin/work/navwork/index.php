...
$aname=$_SESSION['aname'];
  ...
  echo "<script>window.location='../../logout/'</script>";
    ...
    $resultworkpart=$object->Readworkpart();
?>
<nav class="navbar navbar-expand-lg navbar-light bg-primary">
<a class="navbar-brand" href="#" style="font-size: 16px;padding: 0px 6px 0px 12px;color: white;"><b>DASHBORAD<br>STATUS : <?php echo $_SESSION['aname'] ?></b></a>
