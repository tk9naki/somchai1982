...
<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
	...
	<div class="modal-body">
			...
			<div class="mb-3">
				...
				<select name="pname" class="form-select" disabled>
				...
				<input type="text"  name="fname" class="form-control" value="<?php echo $row['fname']?>" disabled>
				</div>
				</div>
				</div>
				</div>
				...
				<div class="form-group">
				<div class="input-group">
				<input type="text"  name="lname" class="form-control" value="<?php echo $row['lname']?>" disabled>
				</div>
				</div>
				</div>
				</div>
				...
				<div class="form-group">
				<div class="input-group">
				<input type="text"  name="lname" class="form-control" value="<?php echo $row['password']?>" disabled>
				</div>
				</div>
				</div>
				</div>
