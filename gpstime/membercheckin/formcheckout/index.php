...
<form class="myForm" action="../checkout/" method="post">
<input type="hidden" name="timeout" value="<?php echo date("Y-m-d H:i:s"); ?>">
<input type="hidden" name="dateinname" value="<?php echo $row['dateinname']; ?>">
...
<input type="hidden" name="mname" value="<?php echo $mname; ?>">
	<div class="row">
		<div class="col-md-4"></div>
			...
			<input type="hidden" name="latout" class="form-control" value="">
			</div>
			</div>
			</div>
			<div class="col-md-6">
			<div class="form-group">
			<div class="input-group">
			<input type="hidden" name="lonout" class="form-control" value="">
			</div>
			</div>
			</div>
			</div>
...
<script type="text/javascript">
  ...
  function showPosition(position){
    document.querySelector('.myForm input[name="latout"]').value=position.coords.latitude;
    document.querySelector('.myForm input[name="lonout"]').value=position.coords.longitude;
  }
